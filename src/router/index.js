...
import shopList from '../controllers/shopList'
import profile from '../controllers/profile'
import goodslist from '../controllers/goodslist'
...
export default class Router {
  constructor(obj) {
    ...
    this.routes = {
      ...
      '/index/search':search,
      '/index/search/searchresult':searchresult,
      '/index/home': home,
      '/index/home/position': position,
      '/index/home/classify': classify,
      '/index/home/shopList': shopList,
      '/index/home/profile': profile,
      '/index/home/goodslist': goodslist
    }
    // 组件挂载根元素
    this.root = $('#main')
    // 导航菜单列表
